...
export const Header = () => {
  ...
  const handleSubmit = (event) => {
    ...
    const queryTern = event.target.q.value;
    event.target.reset();

    navigate(`/search?q=${ queryTern }`)
  }
          ...
          <div className="flex md:order-2">
            ...
            <div className="relative hidden md:block">
              ...
              <form onSubmit={ handleSubmit }>
                <input type="text" name="q" id="search-navbar" className="block w-full p-2 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search..." autoComplete="off" />
              </form>
            </div>
